...
install("less");                                                             // 70
install("jeeeyul:moment-with-langs");                                        // 71
install("deps");                                                             // 72
install("htmljs");                                                           // 73
...
install("markdown");                                                         // 78
install("reactive-dict");                                                    // 79
install("session");                                                          // 80
install("ui");                                                               // 81
install("iron:core");                                                        // 82
install("iron:dynamic-template");                                            // 83
install("iron:layout");                                                      // 84
install("iron:url");                                                         // 85
install("iron:middleware-stack");                                            // 86
